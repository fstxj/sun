    ...
    SubShader {
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                ...
                o.uv0 = v.texcoord0;
                float4 node_9696 = _Time + _TimeEditor;
                float2 node_7739 = (o.uv0+node_9696.g*float2(-0.007,0));
...
////// Lighting:
                float4 node_9696 = _Time + _TimeEditor;
                float2 node_3517 = (i.uv0+node_9696.g*float2(0.1,0));
                float4 node_4517 = tex2D(_node_5770,TRANSFORM_TEX(node_3517, _node_5770));
                float3 node_7031 = (_node_9624.rgb*(1.0 - saturate((sceneZ-partZ)/(_qiangdu*node_4517.r)))*saturate((sceneZ-partZ)/_bianyuanxiaoshi));
                float3 finalColor = node_7031;
        ...
        Pass {
            ...
            VertexOutput vert (VertexInput v) {
                VertexOutput o = (VertexOutput)0;
                o.uv0 = v.texcoord0;
                float4 node_4021 = _Time + _TimeEditor;
                float2 node_7739 = (o.uv0+node_4021.g*float2(-0.007,0));
                float4 node_1804 = tex2Dlod(_node_5770,float4(TRANSFORM_TEX(node_7739, _node_5770),0.0,0));
                float node_643 = 0.0;
                v.vertex.xyz += (node_643 + ( (node_1804.rgb - _min) * (1.0 - node_643) ) / (_max - _min));
                o.pos = UnityObjectToClipPos(v.vertex );
